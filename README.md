...
Builds a vertical short each day from a local topic bank: narration via edge-tts, stock or generated stills, ffmpeg for motion and captions, then an scheduled upload. Runs entirely on GitHub Actions.
